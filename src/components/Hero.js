  ...
  return (
    <div className='flex flex-col w-full items-center justify-center bg-[#40394A] h-screen relative' id='home'>
      ...
      <div className='flex w-full absolute'>
        ...
        <div className='mt-[50px] sm:mt-0' data-aos="fade-down" data-aos-duration="1200">
        ...
        <div className='flex  mr-[20px] mt-[100px] sm:mt-[60px] mb-[40px]  md:mt-0 items-center justify-center md:mr-0 md:mb-0' data-aos="fade-up" data-aos-duration="1200">
          <img  src={isa} alt='isa'/>
