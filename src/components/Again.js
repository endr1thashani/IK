...
const Again = () => {
  ...
  return (
    <div className='flex flex-col w-full items-center max-w-[1240px] mt-[20px] mx-auto md:mt-[440px] md:flex-row' id='about'>
        ...
        <div className='mt-[70px] ml-[12px] md:mt-0 md:ml-[130px]' data-aos="fade-down" data-aos-duration="1200">
